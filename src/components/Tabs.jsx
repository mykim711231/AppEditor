        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="ml-2 flex h-10 w-10 items-center justify-center rounded text-slate-400 hover:bg-slate-300 hover:text-slate-700 active:bg-slate-400 dark:hover:bg-slate-600 dark:hover:text-white"
              aria-label="탭 닫기"
            >
              <X size={16} />
            </button>
